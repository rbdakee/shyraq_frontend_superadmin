...
> - **`/operations/billing` поле "Kindergarten"** — backend возвращает 400 при передаче `kindergarten_id`. См. [`#b12`](OPEN_QUESTIONS.md#b12-single-kindergarten-billing-trigger--parked).
>
...
├──────────────────────────────────────────────────────────────────────┤
│  Показано 1–20 из 42                       [← Назад]  [Далее →]      │ ← pagination
└──────────────────────────────────────────────────────────────────────┘
```
...
- Pagination — `Prev/Next` без номеров страниц, range-label "Показано X–Y из N":
